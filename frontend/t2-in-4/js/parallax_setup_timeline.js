...
if($(this).hasClass('height50')){
var startEnd = (400 + scrollCount);
var finish = (1000 + scrollCount);
var finishEnd = (1400 + scrollCount);
var finish2 = (2000 + scrollCount);
var finishEnd2 = (2400 + scrollCount);

var object = {

[start] :"transform:translate(0,200vh);",
 [startEnd] :"transform:translate(0,0vh);",
'triggerin': startEnd,
[finish] :"transform:translate(0,0vh);",
'triggerout' : finish, 
[finishEnd] :"transform:translate(0,-62vh);",
'triggerinbot' : finishEnd, 
[finish2] :"transform:translate(0,-62vh);",
'triggeroutbot' : finish2, 
[finishEnd2] :"transform:translate(0,-200vh);",
'color': color};
scrollCount = scrollCount + 1900;

} else if($(this).hasClass('height80')){

var startEnd = (400 + scrollCount);
var finish = (1000 + scrollCount);
var finishEnd = (1500 + scrollCount);
var finish2 = (2200 + scrollCount);
var finishEnd2 = (2600 + scrollCount);
...
[finish] :"transform:translate(0,0vh);",
'triggerout' : finish, 
[finishEnd] :"transform:translate(0,-82vh);",
'triggerinbot' : finishEnd, 
[finish2] :"transform:translate(0,-82vh);",
'triggeroutbot' : finish2, 
[finishEnd2] :"transform:translate(0,-200vh);",
'color': color};
scrollCount = scrollCount + 2100;
} else if($(this).hasClass('height100')){
...
[finish] :"transform:translate(0,0vh);",
'triggerout' : finish, 
[finishEnd] :"transform:translate(0,-100vh);",
'triggerinbot' : finishEnd, 
[finish2] :"transform:translate(0,-100vh);",
'triggeroutbot' : finish2, 
[finishEnd2] :"transform:translate(0,-200vh);",
'color': color};
scrollCount = scrollCount + 2100;

} else if($(this).hasClass('heightdouble')){
...
[start] :"transform:translate(0,200vh);",
 [startEnd] :"transform:translate(0,0vh);",
 [startEnd+100] :"transform:translate(0,0vh);",
'triggerin': startEnd,
[finish] :"transform:translate(0,-30vh);",
'triggerout' : finish, 
[finishEnd] :"transform:translate(0,-60vh);",
'triggerinbot' : finishEnd, 
[finish2] :"transform:translate(0,-60vh);",
'triggeroutbot' : finish2, 
[finishEnd2] :"transform:translate(0,-200vh);",
'color': color};
scrollCount = scrollCount + 2100;
...
i = 0;
		 ...
		 inTrigBot = parseInt(jQuery(this).attr('data-triggerinbot'));
		 outTrig = parseInt(jQuery(this).attr('data-triggerout'));
		 outTrigBot = parseInt(jQuery(this).attr('data-triggeroutbot'));
		inTrigin =  inTrig + (delay*i) - 200;
       outTrigin =  inTrig + (delay*i);
       	inTrigout = outTrig + (delay*i) +1;
       outTrigout = outTrig + (delay*i) + 200;
       ...
       // ------------------------ SETUP parent dependent running elements while slide is locked in  -----------------------------
		...
		jQuery(this).find('.running').each( function(count) {
			...
			runningDir = jQuery(this).attr('running');
			    if(runningDir == 'top'){
     			 run = 'transform:translate(0vw,-20vh)';
     			 } else if (runningDir == 'bot'){
     			  run = 'transform:translate(0vw,20vh)';
     			 }  else if (runningDir == 'left'){
     			  run = 'transform:translate(-20vw,0vh)';
     			  ...
     			  } else if (runningDir == 'lefttiny'){
     			  run = 'transform:translate(-5vw,0vh)';
     			  } else if (runningDir == 'righttiny'){
     			  run = 'transform:translate(5vw,0vh)';
     			  } else if (runningDir == 'bottiny'){
     			  run = 'transform:translate(0vw,5vh)';
		 	...
		 	if(jQuery(this).hasClass('botrunning')){
		 			runTrig = inTrigBot + 100;
		 			Trigrun = outTrigBot;
		 			console.log('is 150');
		 			} else {
		 			runTrig = runTrig + 100;
