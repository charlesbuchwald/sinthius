...
//The options (second parameter) are all optional. The values shown are the default values.
   ...
   $(document).ready(function(){
	...
	function initMap() {
$('#contents .image-container').each(function(index){
          ...
          for (i = 1; i < index; i++) {
            areaTop += $('#contents div#container' + i).height() + imageContainerMargin;
          }

          areaBottom = areaTop + $('#contents div#container' + index).height();
          ...
          $('div#contents').scroll(function() {
            ...
            if ($(this).scrollTop() >= areaTop && $(this).scrollTop() < areaBottom) {
              $('#contents .image-container').removeClass("inFocus").addClass("outFocus");
              $('#contents div#container' + index).addClass("inFocus").removeClass("outFocus");
				$('#rendermap img').removeClass("inFocus").addClass("outFocus")
				$('#rendermap img').eq(index).addClass("inFocus").removeClass("outFocus");
				console.log(areaTop+'≤top bot>'+areaBottom+'scroll'+$(this).scrollTop()+'index'+ index)
            }
          });

	})
	$('#contents2 .image-container').each(function(index){
          ...
          // Calculating total height of blocks above active
          for (i = 1; i < index; i++) {
            areaTop += $('#contents2 div#container2' + i).height() + imageContainerMargin;
          }

          areaBottom = areaTop + $('#contents2 div#container2' + index).height();

          $('div#contents2').scroll(function() {
          
          
          
            if ($(this).scrollTop() >= areaTop && $(this).scrollTop() < areaBottom) {
              $('#contents2 .image-container').removeClass("inFocus").addClass("outFocus");
              $('#contents2 div#container2' + index).addClass("inFocus").removeClass("outFocus");
				$('#rendermap2 img').removeClass("inFocus").addClass("outFocus")
				$('#rendermap2 img').eq(index).addClass("inFocus").removeClass("outFocus");
				console.log(areaTop+'≤top bot>'+areaBottom+'scroll'+$(this).scrollTop()+'index'+ index)
            }
          });
            ...
            $('#contents,#contents2').append("<div class='space-at-the-bottom'></div>");

   $('#rendermap2 img').eq(0).addClass("inFocus").removeClass("outFocus");
 $('#rendermap img').eq(0).addClass("inFocus").removeClass("outFocus");
   $('div#container21').addClass("inFocus").removeClass("outFocus");
 $('div#container1').addClass("inFocus").removeClass("outFocus");
}
