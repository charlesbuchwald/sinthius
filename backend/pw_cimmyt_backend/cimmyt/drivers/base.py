...
from cimmyt import constants, compat
from cimmyt.errors import ClientError
from cimmyt.op.manager import purge_settings, factory
from cimmyt.utils.async import dispatch, dispatch_return
from cimmyt.utils.binary import want_bytes
from cimmyt.utils.serializers import parser_types, complex_types, \
    deserialize_complex_types, serialize_complex_types, jsonloads
from cimmyt.utils.typetools import to_boolean
...
def _fetch(url, method='GET', body=None, headers=None, callback=None, **kwargs):
    ...
    response = kwargs.get('sanitizer', _response_json_sanitizer)(response)
