...
if __name__ == '__main__':
    ...
    os.environ.setdefault(ENV_SETTINGS_MODULE, 'cimmyt_octopus.settings')
    ...
    # Imports
    from cimmyt.utils.filetools import check_requirements
    from cimmyt.server.base import start_server, stop_server
